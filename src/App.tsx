  ...
  if (!authenticated) {
    return (
      <div className="h-full flex items-center justify-center bg-[var(--bg)]">
        ...
        />
        <div className="relative z-10 flex flex-col items-center gap-8 text-center px-8 max-w-md w-full">
          <div>
            <div className="font-display text-3xl md:text-4xl font-extrabold text-[var(--green)] tracking-tight mb-2">
              ON-CHAIN ANALYST
            </div>
          ...
          <div className="flex flex-wrap gap-2 justify-center">
            {['Alchemy', 'Claude AI', 'MPP Payments'].map((f) => (
              <span
                key={f}
                className="text-[11px] font-mono px-2.5 py-1 border border-[var(--border-2)] text-[var(--muted)] rounded-sm"
              >
                {f}
              </span>
            ))}
          ...
          <button
            ...
            className="
              ...
              bg-[var(--green-a10)] border border-[var(--green-a40)] text-[var(--green)]
              rounded-lg hover:bg-[var(--green-a20)] hover:border-[var(--green-a70)]
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={toggleTheme}
              className="text-[10px] font-mono text-[var(--muted-a40)] hover:text-[var(--muted)] transition-colors"
